  ...
  function renderHome() {
    ...
    main.innerHTML = `<div class="page">
      ...
      <section class="section">
        ...
        <div class="roadmap">${course.stages.map(stage => `<a href="#/course?stage=${stage.id}" class="roadmap-node ${stage.id > 3 ? 'locked' : ''}" data-stage="${String(stage.id).padStart(2,'0')}"><strong>${stage.title}</strong></a>`).join('')}</div>
      </section>
